...
const BLUE_SHAPES: Record<SignalVariant, Array<{
  ...
  landing: [
    { x: "0%", y: "16%", w: "420px", h: "130px", scale: "1.16", delay: "0s", duration: "18s", rotate: "-18deg" },
    { x: "100%", y: "26%", w: "460px", h: "140px", scale: "1.14", delay: "2.6s", duration: "20s", rotate: "14deg" },
    { x: "86%", y: "92%", w: "390px", h: "120px", scale: "1.18", delay: "4.1s", duration: "22s", rotate: "-10deg", desktopOnly: true },
    { x: "5%", y: "82%", w: "360px", h: "110px", scale: "1.15", delay: "1.4s", duration: "23s", rotate: "12deg", desktopOnly: true },
  ],
  analysis: [
    { x: "-2%", y: "28%", w: "430px", h: "132px", scale: "1.16", delay: "0.4s", duration: "18s", rotate: "13deg" },
    { x: "100%", y: "68%", w: "500px", h: "148px", scale: "1.13", delay: "2.2s", duration: "21s", rotate: "-14deg", desktopOnly: true },
    { x: "70%", y: "6%", w: "320px", h: "100px", scale: "1.18", delay: "4s", duration: "20s", rotate: "9deg" },
    { x: "18%", y: "96%", w: "390px", h: "118px", scale: "1.15", delay: "1.5s", duration: "23s", rotate: "-8deg", desktopOnly: true },
  ],
  reveal: [
    { x: "-2%", y: "18%", w: "440px", h: "130px", scale: "1.14", delay: "0s", duration: "19s", rotate: "-14deg" },
    { x: "100%", y: "30%", w: "520px", h: "154px", scale: "1.16", delay: "2s", duration: "21s", rotate: "14deg" },
    { x: "82%", y: "94%", w: "400px", h: "122px", scale: "1.18", delay: "4.4s", duration: "22s", rotate: "-9deg", desktopOnly: true },
    { x: "4%", y: "74%", w: "360px", h: "112px", scale: "1.14", delay: "1.2s", duration: "23s", rotate: "10deg", desktopOnly: true },
  ],
  dashboard: [
    { x: "-2%", y: "26%", w: "430px", h: "128px", scale: "1.14", delay: "0.8s", duration: "20s", rotate: "13deg" },
    { x: "102%", y: "22%", w: "480px", h: "142px", scale: "1.12", delay: "2.8s", duration: "22s", rotate: "-12deg", desktopOnly: true },
    { x: "86%", y: "82%", w: "420px", h: "120px", scale: "1.16", delay: "4.8s", duration: "23s", rotate: "10deg" },
    { x: "4%", y: "88%", w: "380px", h: "112px", scale: "1.14", delay: "1.8s", duration: "24s", rotate: "-10deg", desktopOnly: true },
  ],
  recommendation: [
    { x: "-2%", y: "22%", w: "450px", h: "136px", scale: "1.14", delay: "0s", duration: "19s", rotate: "-14deg" },
    { x: "101%", y: "30%", w: "520px", h: "150px", scale: "1.15", delay: "2.4s", duration: "22s", rotate: "12deg" },
    { x: "82%", y: "86%", w: "430px", h: "126px", scale: "1.18", delay: "4.2s", duration: "23s", rotate: "-9deg", desktopOnly: true },
    { x: "6%", y: "88%", w: "390px", h: "116px", scale: "1.14", delay: "1.5s", duration: "24s", rotate: "9deg", desktopOnly: true },
  ],
};
